...
//  EssentialFeedTests
//
//  Created by Iván GalazJeria on 13-08-21.
//
...
final class URLSessionHTTPClient {
    ...
    struct UnexpectedValuesRepresentations: Error {}
...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getGromURL_failsOnRequestError() {
    ...
    func test_getGromURL_failsOnAllInvalidRepresentationCases() {
